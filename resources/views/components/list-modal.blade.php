...
}" x-on:close.stop="show = false" x-on:keydown.window="handleKeyDown($event)" x-show="show"
    class="fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-[100]" style="display: none;">
    <div class="fixed inset-0 transform transition-all">
        <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
    </div>

    <div x-show="show" class="relative mx-auto bg-white overflow-hidden shadow-xl transform transition-all"
